...
def predict():
    ...
    print(img1)
    image_path="D:/Diabetic RetinoPathy Detection Using ML and Image processing/DRD_VsCode/Diabetic Ratinopathy Website/website/testimage/"+img1.filename
    ...
    print(img2)
    image_path2="D:/Diabetic RetinoPathy Detection Using ML and Image processing/DRD_VsCode/Diabetic Ratinopathy Website/website/testimage/"+img2.filename
